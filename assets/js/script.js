/*
Case Sensitive = reconhecve lettra maisculas e minusculas
...
function validaAssunto() {
    ...
    if (assunto.value.length >= 3) {
        ...
        txtAssunto.style.backgroundColor = 'white'
...
function enviar() {
    if (nomeOk == true && emailOk == true && assuntoOk == true) {
        alert("Formulario enviado com suucesso!")
    } else {
